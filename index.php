...
$site = [
  ...
  'linkedin' => 'https://id.linkedin.com/in/waqiatturrachmat',
...
$principles = [
  ...
  'AI Prompt Engineer: Mahir merancang dan menyusun prompt untuk model AI agar menghasilkan output yang akurat dan relevan.',
...
$projects = [
  [
    'title' => 'Website Berita Sepak Bola',
    'desc' => 'Website Content Management System (CMS) sederhana untuk portal berita sepak bola',
    'stack' => 'PHP, Tailwind CSS, JS',
    'url' => 'project/website-berita-sepak-bola.pdf'
  ],
];
...
$certificates = [
  ...
  'assets/images/cert3.jpg',
  'assets/images/toufel.jpeg',
...
<body class="antialiased">
  ...
  <div class="relative overflow-hidden">
    ...
    <header class="max-w-6xl mx-auto px-6 py-6 flex items-start justify-between relative z-10">
      <div class="flex items-start gap-4">
       ...
       <nav class="space-x-3 text-sm hidden md:block">
      ...
      <section id="contact" class="py-8">
        ...
        <div class="mt-4 grid md:grid-cols-2 gap-6 items-start">
          ...
          <div class="glass p-6 space-y-4 reveal" data-reveal>
            ...
            <a href="<?=htmlspecialchars($site['linkedin'])?>" target="_blank" rel="noopener noreferrer" class="contact-item hoverable" title="LinkedIn">
               <div style="flex:1"><div class="text-sm font-semibold">LinkedIn</div><div class="text-xs text-slate-500"><?=parse_url($site['linkedin'], PHP_URL_HOST)?></div></div>
            </a>
